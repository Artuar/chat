...
describe("Content", () => {
  ...
  const mountContentComponent = (tradesInitialState = {}, userInitialState = {}, route = '') => {
  ...
  it("should call fetchUser", () => {
    ...
    expect(store.getActions()[2]).toEqual(userActions.requestUserData.request());
  });
  ...
  it("should call fetchTrades", () => {
    ...
    expect(store.getActions()[1]).toEqual(notificationsActions.requestNotifications.request());
  });
